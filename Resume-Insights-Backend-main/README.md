...
> 📘 **Quick Start Guide:** For detailed step-by-step instructions in Hindi/English, see [`Start.md`](./Start.md)
...
5.  **Run the Backend Server:**
    ...
    ```
    /// Users/jitendrayadav/Downloads/Resume-Insights-Backend-main/.venv/bin/python -m uvicorn main:app --host 127.0.0.1 --port 8000 --reload
